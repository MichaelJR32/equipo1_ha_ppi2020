...
class AppPreguntas2 extends Component{
  constructor(props) {
    super(props);
    this.state = {
      questions: [
        {
          ...
          choices: [
            {
              id: 'a',
              text: 'Podemos encontrarlos en parqueaderos, colegios y universidades.'
            },
            {
              id: 'b',
              text: 'Podemos encontrarlas comúnmente en carreteras, zonas peligrosas y vialidades urbanas.'
            },
            {
              id: 'c',
        ...
        },
        {
          ...
          choices: [
            {
              id: 'a',
              text: 'Su proposito es mejorar la vista de los conductores en las carreteras.'
            },
            {
              id: 'b',
              text: 'Su proposito es advertir a los usuarios de las vias de riesgo.'
            },
            {
              id: 'c',
              text: 'Su proposito es incitar al conductor a que no tome precauciones en la via.'
            },
            {
              id: 'd',
        ...
        {
          id: 3,
          text: '¿Cuáles son los colores distintivos de las señales preventivas ?',
          choices: [
            {
              id: 'a',
